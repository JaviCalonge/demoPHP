  ...
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <form method="POST" action="/note">
      ...
      <div class="col-span-full">
        <label for="body" class="block text-sm/6 font-medium text-gray-900">Rewrite your note:</label>
        <div class="mt-2">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        ...
        <a href="/notes" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Cancel</a>
      </div>
    </form>
  </div>
</main>
